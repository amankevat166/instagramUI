...
import 'package:instagram/firebase/firebase_auth/forgot_password_controller.dart';
          ...
          children: [
            ...
            Obx(
                  ...
                  callback: () async {
                    ...
                    if(email.isEmpty){
                      UiHelper.alertDialog(context, "Forgot pass", "Email can't be Empty");
                    }
                    else{
                      forgotPass(email);
                    }
            ...
            UiHelper.elevatedButton(context: context, callback: ()=>Get.offAllNamed(MyRoutes.login), text: "Back"),
          ],
        ),
      ),
    );
